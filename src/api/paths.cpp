...
std::string Ark::Client::API::Paths::Blocks::all(
  ...
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Blocks::base(), limit, page);
  return url;
}
...
{
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s/%s/transactions", newHost.toString().c_str(), Ark::Client::API::Paths::Blocks::base(), blockId);
  return url;
}
...
{
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s/%s", newHost.toString().c_str(), Ark::Client::API::Paths::Delegates::base(), identifier);
  return url;
}
...
std::string Ark::Client::API::Paths::Delegates::all(
  ...
  char uri[128] = {};
  snprintf(uri, sizeof(uri), "%s%s?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Delegates::base(), limit, page);
  return uri;
}
...
std::string Ark::Client::API::Paths::Delegates::blocks(
  ...
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s/%s/blocks?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Delegates::base(), identifier, limit, page);
  return url;
}
...
std::string Ark::Client::API::Paths::Delegates::voters(
  ...
  char url[128] = { };
  snprintf(url, sizeof(url), "%s%s/%s/voters?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Delegates::base(), identifier, limit, page);
  return url;
}
...
std::string Ark::Client::API::Paths::Peers::all(
  ...
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Peers::base(), limit, page);
  return url;
}
...
std::string Ark::Client::API::Paths::Transactions::getUnconfirmed(
  ...
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s/unconfirmed/%s", newHost.toString().c_str(), Ark::Client::API::Paths::Transactions::base(), identifier);
  return url;
}
...
std::string Ark::Client::API::Paths::Transactions::all(
  ...
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Transactions::base(), limit, page);
  return url;
}
...
std::string Ark::Client::API::Paths::Transactions::get(
  ...
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s/%s", newHost.toString().c_str(), Ark::Client::API::Paths::Transactions::base(), identifier);
  return url;
}
...
std::string Ark::Client::API::Paths::Transactions::allUnconfirmed(
  ...
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s/unconfirmed?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Transactions::base(), limit, page);
  return url;
}

/***/

std::string Ark::Client::API::Paths::Transactions::types(
    Host& newHost
) {
  char url[128] = {};
...
std::string Ark::Client::API::Paths::Votes::all(
  ...
  char url[128] = { };
  snprintf(url, sizeof(url), "%s%s?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Votes::base(), limit, page);
  return url;
}
...
std::string Ark::Client::API::Paths::Wallets::get(
  ...
  char url[128] = { };
  snprintf(url, sizeof(url), "%s%s/%s", newHost.toString().c_str(), Ark::Client::API::Paths::Wallets::base(), identifier);
  return url;
}
...
std::string Ark::Client::API::Paths::Wallets::all(
  ...
  char url[128] = { };
  snprintf(url, sizeof(url), "%s%s?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Wallets::base(), limit, page);
  return url;
}
...
std::string Ark::Client::API::Paths::Wallets::top(
  ...
  char url[128] = { };
  snprintf(url, sizeof(url), "%s%s/top?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Wallets::base(), limit, page);
  return url;
}
...
std::string Ark::Client::API::Paths::Wallets::transactions(
  ...
  char url[128] = {};
  snprintf( url, sizeof(url), "%s%s/%s/transactions?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Wallets::base(), identifier, limit, page);
  return url;
}
...
std::string Ark::Client::API::Paths::Wallets::transactionsSent(
  ...
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s/%s/transactions/sent?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Wallets::base(), identifier, limit, page);
  return url;
}
...
std::string Ark::Client::API::Paths::Wallets::transactionsReceived(
  ...
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s/%s/transactions/received?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Wallets::base(), identifier, limit, page);
  return url;
}
...
std::string Ark::Client::API::Paths::Wallets::votes(
  ...
  char url[128] = {};
  snprintf(url, sizeof(url), "%s%s/%s/votes?limit=%d&page=%d", newHost.toString().c_str(), Ark::Client::API::Paths::Wallets::base(), identifier, limit, page);
  return url;
}
