...
std::string Ark::Client::API::Transactions::getUnconfirmed(
  ...
  return http_->get(
    Ark::Client::API::Paths::Transactions::getUnconfirmed(this->host_, identifier).c_str()
  );
}
...
std::string Ark::Client::API::Transactions::all(
  ...
  return http_->get(
    Ark::Client::API::Paths::Transactions::all(this->host_, limit, page).c_str()
  );
}
...
std::string Ark::Client::API::Transactions::get(
  ...
  return http_->get(
    Ark::Client::API::Paths::Transactions::get(this->host_, identifier).c_str()
  );
}
...
std::string Ark::Client::API::Transactions::allUnconfirmed(
  ...
  return http_->get(
    Ark::Client::API::Paths::Transactions::allUnconfirmed(this->host_, limit, page).c_str()
  );
}
...
std::string Ark::Client::API::Transactions::types() {
  return http_->get(
    Ark::Client::API::Paths::Transactions::types(this->host_).c_str()
  );
}
